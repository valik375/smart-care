...
const serviceList = [
  {
    image: '../assets/security-function-1.png',
    icon: '../assets/white-shield.svg',
    title: 'Інтеграція зі службою охорони',
  ...
  {
    image: '../assets/security-function-3.png',
  ...
  {
    image: '../assets/security-function-4.png',
    icon: '../assets/white-lock.svg',
    title: 'Розумні замки',
    text: 'Включає в себе взаємодію між розумною системою та професійною охоронною службою.',
    price: '90',
    url: '#',
  },
  {
    image: '../assets/security-function-5.png',
    icon: '../assets/white-camera.svg',
    title: 'Відеоспостереження',
    text: 'Комплексне рішення, що містить у собі багато варіантів оснащення. Завдяки системі відеоспостереження ви маєте найбільший спектр варіантів захисту від зловмисників та протидії їм',
    price: '150',
    url: '#',
  },
]
